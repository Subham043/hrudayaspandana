        ...
        <div class="wrapper">
            <div class="hundi-row">
                <div class="col-lg-7 col-md-8 col-sm-12">
                    <div class="heading">
                        <h4 class="lower-heading">e-Hundi</h4>
                    </div>
                    <form id="hundiForm" action="<?php echo base_url('e-hundi'); ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <input type="text" id="city" name="city" class="form-control form-hundi-input"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <input type="text" id="state" name="state" class="form-control form-hundi-input"
                        ...
                        <div class="mb-3" id="pan_div" style="display: none;">
                            <input type="text" id="pan" name="pan" class="form-control form-hundi-input"
                                placeholder="PAN No." value="<?php echo set_value('pan'); ?>">
                            <div style="color:red;"><?php echo form_error('pan'); ?></div>
                        </div>
                        <div class="mb-3">
                            <input type="text" id="amount" name="amount" class="form-control form-hundi-input"
