        ...
        <div class="wrapper">
            <div class="hundi-row login-main-row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <form action="<?php echo base_url('forgot-password'); ?>" id="forgot_password_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="email" autocomplete="off" class="form-control form-hundi-input"
