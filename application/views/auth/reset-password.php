        ...
        <div class="wrapper">
            <div class="hundi-row login-main-row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <form action="<?php echo base_url('reset-password/'.$id); ?>" id="otp_form" method="post">
                    <input autocomplete="off" type="hidden"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <div class="errorTxt"></div>
                                    <input type="password" name="password" id="password" autocomplete="off" class="form-control form-hundi-input"
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <div class="errorTxt"></div>
                                    <input type="password" name="cpassword" id="cpassword" autocomplete="off" class="form-control form-hundi-input"
                                        placeholder="Password">
