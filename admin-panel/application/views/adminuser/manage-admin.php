                                ...
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          ...
                                          <th id="c" class="h5-para-p2" width="120px">Sub Division</th>
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <td ><?php   
                                          ...
                                          if(!empty($value->subdivision)){

                                          foreach($value->subdivision as $sub){
                                             echo $sub->sub_division_name.'<br />';
                                          }
                                       }
                                      
                                      
                                      ?></td>
                                      <td><span class='<?php if ($value->admin_type=='1') {echo "super"; } else{echo "sub"; } ?>'><?php 
