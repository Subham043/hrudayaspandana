            ...
            <div class="row">
                ...
                <div class="col m12 s12 l9">
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m6">
                                <p class="h5-para black-text m0">E-Hundi</p>
                            </div>
                            <div class="col s12 m6 l6 right-align">
                                <a href="<?php echo base_url('e-hundi/add'); ?>" class="btn btn-form btn-submit">Add
                                    E-Hundi</a>
                            </div>
                        </div>
                        ...
                        <div class="shorting-table">
                            <div>
                                <div class="col l12 m12 s12">
                                    <div class="">
                                        <p class="h5-para-p2">Manage E-Hundi </p>
                                        <table id="dynamic" class="striped">
                                            <thead>
                                                <tr class="tt">
                                                    ...
                                                    <th id="b" class="h5-para-p2" width="100px">Trust</th>
                                                    <th id="b" class="h5-para-p2" width="100px">Amount</th>
                                                    <th id="b" class="h5-para-p2" width="100px">User Status</th>
                                                    <!-- <th id="b" class="h5-para-p2" width="100px">Payment Id</th> -->
                                                </tr>
                                            </thead>
                                            <tbody>
                                      ...
                                      ?>
                                                <tr>
                                                    ...
                                                    <td class="action-btn  center-align">
                                                        <!-- view user -->
                                                        <a href="<?php echo base_url('e-hundi/view/'.$this->encryption_url->safe_b64encode($value->id).'') ?>"
                                                            class="blue hoverable"><i class="far fa-eye "></i></i></a>
                                                        <a href="<?php echo base_url('e-hundi/edit/'.$this->encryption_url->safe_b64encode($value->id).'') ?>"
                                                    ...
                                                    <td><?php echo (!empty($value->fname))?$value->fname.' '.$value->lname:'---' ; ?>
                                                    </td>
...
function myconfirmPromt(id) {
  ...
  if(ans!=false){
    window.location.href = "<?php echo base_url('e-hundi/delete/'.'') ?>"+id;
  }
}
</script>
