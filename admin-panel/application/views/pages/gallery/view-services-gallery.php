...
<body>
                    ...
                    <div class="main-bar">
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <fieldset>
                                    <legend>Add Image For <?php echo $type; ?></legend>
                                    <div class="input-type-block">
                                        <form
                                            action="<?php echo base_url('gallery/images/upload/'.$pagetype); ?>"
                                ...
                                <fieldset>
                                    <legend>Gallery Preview For <?php echo $type; ?></legend>
                                    <div class="input-type-block">
    ...
    <script>
        ...
        function getImage() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url().'gallery/images/view/'.$pagetype ;?>",
                processData: false,
                contentType: false,
                cache: false,
                async: false,
                                                            ...
                                                            <div class="img-container">
                                                                ...
                                                                <div class="middle">
                                                                    <div class="text">
                                                                        ...
                                                                        <a href="<?php echo base_url(); ?>gallery/images/delete/${response.result[i]['id']}/<?php echo $pagetype; ?>"
                                                                            class="deletebtn"><i
