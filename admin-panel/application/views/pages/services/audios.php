...
<body>
            ...
            <div class="row">
                ...
                <div class="col m12 s12 l9">
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m6">
                                <p class="h5-para black-text m0">Service - Audios : <?php echo $pagetype; ?></p>
                            </div>
                            <div class="col s12 m6 l6 right-align">
                                <a href="<?php echo base_url('services/new/gallery/audio/'.$this->encryption_url->safe_b64encode($id).'/'.$type); ?>"
                                      ...
                                      ?>
                                                <tr>
                                                    ...
                                                    <td class="action-btn  center-align">
                                                        <a href="#!"
                                                            onclick="myconfirmPromt('<?php echo $this->encryption_url->safe_b64encode($value->id) ?>')"
    ...
    function myconfirmPromt(id, type) {
        ...
        if (ans != false) {
            window.location.href = "<?php echo base_url('services/new/gallery/new/audio/delete/'.'') ?>" + id;
        }
    }
    </script>
