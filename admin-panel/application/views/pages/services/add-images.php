                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Service Image - Add</p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <form
                                    action="<?php echo base_url('services/new/gallery/image/'.$this->encryption_url->safe_b64encode($id).'/'.$type); ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s12 m6 l6 img " style="margin-top:15px;">
                                                    ...
                                                    <div class="endorsement file-field input-field">
                                                        ...
                                                        <h6 class=" m0">
                                                            <small> <i><b>Note</b>: Please upload service image
                                                                    <br>
                                                                    <span class="bold">Max file size:</span> 512kb <span
                                                                        class="red-text">*</span></i>
                                                                <br>
                                                                <span class="bold">Prefered image dimension:</span> 700
                                                                x 300 <span class="red-text">*</span></i>
                                                            </small>
                                                        </h6>
                                                    </div>
                                                </div>
