                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Services - Add</p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <form action="<?php echo base_url('services/new/add'); ?>" method="post"
                                                ...
                                                <div class="col s12 m6 l6" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control inner-pad" name="page"
                                                            id="page" value="<?php echo set_value('page'); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" id="type"
                                                            ...
                                                            <option value="vedic-rituals"
                                                                <?php echo set_value('type') == 'vedic-rituals' ? 'selected' : ''; ?>>
                                                                Vedic Rituals</option>
                                                            <option value="activities"
                                                                <?php echo set_value('type') == 'activities' ? 'selected' : ''; ?>>
                                                                Activities</option>
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control inner-pad" name="title1"
                                                            id="title1" value="<?php echo set_value('title1'); ?>">
                                                ...
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control inner-pad" name="heading1"
                                                            id="heading1" value="<?php echo set_value('heading1'); ?>">
                                                ...
                                                <div class="col s12 m6 l4 img " style="margin-top:15px;">
                                                    ...
                                                    <div class="endorsement file-field input-field">
                                                        ...
                                                        <h6 class=" m0">
                                                            <small> <i><b>Note</b>: Please upload section 1 image
                                                                    <br>
                                    ...
                                    <fieldset>
                                        <legend>Section 2 - heading (optional)</legend>
                                        <div class="input-type-block">
                                            ...
                                            <div class="row">
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control inner-pad" name="title2"
                                                            id="title2" value="<?php echo set_value('title2'); ?>">
                                                ...
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control inner-pad" name="heading2"
                                                            id="heading2" value="<?php echo set_value('heading2'); ?>">
                                                ...
                                                <div class="col s12 m6 l4 img " style="margin-top:15px;">
                                                    ...
                                                    <div class="endorsement file-field input-field">
                                                        ...
                                                        <h6 class=" m0">
                                                            <small> <i><b>Note</b>: Please upload section 2 image
                                                                    <br>
                                                                    <span class="bold">Max file size:</span> 512kb <span
                                                                        class="red-text">*</span></i>
                                                                <br>
                                    ...
                                    <fieldset>
                                        <legend>Section 2 - Description (optional)</legend>
                                        <div class="input-type-block">
                                                ...
                                                <div class="col s12 m12 l12" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description4" id="description4" rows="10"
                                                            class="form-control inner-pad textarea"><?php echo set_value('description4'); ?></textarea>
                                                        <div style="color:red;">
