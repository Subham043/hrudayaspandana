...
<body>
                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Service Audio</p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <fieldset>
                                    <legend>Add Audio For <?php echo $service->page; ?></legend>
                                    <div class="input-type-block">
                                        <form
                                            action="<?php echo base_url(); ?>services/new/gallery/audio/<?php echo $this->encryption_url->safe_b64encode($service->id); ?>"
                                            method="post" enctype="multipart/form-data">
                                            <input id="demo" type="file" name="files"
                                                accept=".mp3, .wav, .aac, audio/mp3, audio/wav, audio/aac" multiple>
                                        </form>
                                    </div>
                                </fieldset>

                                <fieldset>
                                    <legend>Audio Preview For <?php echo $service->page; ?></legend>
                                    <div class="input-type-block">
    ...
    <script>
        ...
        function getImage() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url().'services/new/gallery/audio/view/'. $this->encryption_url->safe_b64encode($service->id);?>",
                processData: false,
                contentType: false,
                cache: false,
                async: false,
                ...
                success: function(response) {
                    ...
                    for(i=0;i<response.result.length;i++) {
                        ...
                        <p>Click on the button to delete the sound given below: <a href="<?php echo base_url(); ?>services/new/gallery/audio/delete/${response.result[i]['id']}"
                                                                            class="deletebtn"><i
