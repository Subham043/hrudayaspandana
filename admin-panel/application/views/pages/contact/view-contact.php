                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Enquiry No:   <?php echo $result->id;?></p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            ...
                            <div class="ufg-job-application-wrapper">
                                    ...
                                    <fieldset>
                                        <legend>IDENTITY OF THE ENQUIRY</legend>
                                            ...
                                            <div class="row">
                                                <div class="s12 col m12">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input-label" for="address_present"> Message
                                                            <span>*</span></label>
                                                        <textarea readonly class="form-control inner-pad" style="height:90px !important"
                                                            name="residential_address" id="residential_address" row="5"
                                                            value=""><?php echo $result->message;?></textarea>
