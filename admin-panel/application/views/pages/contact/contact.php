                                ...
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          ...
                                          <th id="b" class="h5-para-p2" width="100px">Timestamp</th>
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <td class="action-btn  center-align">
                                        <!-- view user -->
                                        <a href="<?php echo base_url('enquiries/view/'.$this->encryption_url->safe_b64encode($value->id).'') ?>"  class="blue hoverable"><i class="far fa-eye "></i></i></a>
                                        <!-- view user -->
                                      </td>
