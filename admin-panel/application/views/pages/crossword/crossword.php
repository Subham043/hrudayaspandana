...
<body>
                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Crossword</p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <fieldset>
                                    <legend>Add Image For Crossword</legend>
                                    <div class="input-type-block">
                                        <form
                                            action="<?php echo base_url('crossword/upload'); ?>"
                                ...
                                <fieldset>
                                    <legend>Gallery Preview For Crossword</legend>
                                    <div class="input-type-block">
    ...
    <script>
        ...
        function getImage() {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url().'crossword/view' ;?>",
                processData: false,
                contentType: false,
                cache: false,
                async: false,
                        ...
                        data += `<div class="col s12 m6 l4" style="margin-top:15px;">
                                                        <div class="form-group" style="position: relative;">
                                                            ...
                                                            <div class="img-container">
                                                                <img src="<?php echo $this->config->item('web_url')?>assets/images/crossword/${response.result[i]['image']}"
                                                                    alt="Avatar" class="image" style="width:100%">
                                                                <div class="middle">
                                                                    <div class="text">

                                                                        <a href="<?php echo base_url(); ?>crossword/delete/${response.result[i]['id']}"
                                                                            class="deletebtn"><i
