                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col s12 m6 l6">
                                <p class="h5-para black-text m0">Donation - <?php echo $pagetype; ?></p>
                            </div>
                            <div class="col s12 m6 l6 right-align">
                                <p class="h5-para black-text m0">Total Donation - Rs. <?php echo $total_amount[0]->amount; ?></p>
                            </div>
                        ...
                        <div class="shorting-table">
                            <div>
                                <div class="col l12 m12 s12">
                                    <div class="">
                                        <p class="h5-para-p2">Manage Donations </p>
                                      ...
                                      ?>
                                                <tr>
                                                    ...
                                                    <td class="action-btn  center-align">
                                                        <!-- view user -->
                                                        <a href="<?php echo base_url('donation/view/'.$this->encryption_url->safe_b64encode($value->id).'') ?>"
