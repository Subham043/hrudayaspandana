                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Donation No:   <?php echo $result->id;?></p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            ...
                            <div class="ufg-job-application-wrapper">
                                    ...
                                    <fieldset>
                                        <legend>IDENTITY OF THE DONOR</legend>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s6 m4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  autocomplete="off"  readonly type="text" class="form-control inner-pad"
                                                            name="city" id="city" value="<?php echo $result->city;?>">
                                                ...
                                                <div class="col s6 m4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  autocomplete="off"  readonly type="text" class="form-control inner-pad"
                                                            name="trust" id="trust"
                                                            value="<?php echo $result->trust;?>">

                                                    </div>
                                                </div>
                                                <?php if($result->trust=="Sai Mayee Trust"){ ?>
                                                <div class="col s6 m4">
                                                    <div class="form-group">
                                                        <label class="input-label" for="pan">
                                                            PAN No.<span>*</span></label>
                                                        <input  autocomplete="off"  readonly type="text" class="form-control inner-pad"
                                                            name="pan" id="pan" value="<?php echo $result->pan;?>">
                                                ...
                                                <div class="col s6 m4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input-label">Payment Id
                                                            <span>*</span></label>
                                                        <input  autocomplete="off"  readonly type="text" class="form-control inner-pad"
                                                            name="payment_id" id="payment_id"
                                                            value="<?php echo $result->payment_id;?>">
