            ...
            <div class="row">
                ...
                <div class="col m12 s12 l9">
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m6">
                                <p class="h5-para black-text m0">Registration</p>
                            </div>
                        ...
                        <div class="shorting-table">
                            <div>
                                <div class="col l12 m12 s12">
                                    <div class="">
                                        <p class="h5-para-p2">Manage Registration </p>
                                        <table id="dynamic" class="striped">
                                            <thead>
                                                <tr class="tt">
                                                    ...
                                                    <th id="b" class="h5-para-p2" width="100px">Status</th>
                                      ...
                                      ?>
                                                <tr>
                                                    ...
                                                    <td class="action-btn  center-align">
                                                        <!-- view user -->
                                                        <a href="<?php echo base_url('registration/view/'.$this->encryption_url->safe_b64encode($value->id).'') ?>"
                                                            class="blue hoverable"><i class="far fa-eye "></i></i></a>
                                                        <?php if($value->verified==1){ ?>
                                                        <a href="<?php echo base_url('registration/status/'.$this->encryption_url->safe_b64encode($value->id).'/2') ?>"
                                                            class="purple hoverable"><i
                                                                class="fab fa-creative-commons-pd "></i></i></a>
                                                        <?php }else if($value->verified==2){ ?>
                                                        <a href="<?php echo base_url('registration/status/'.$this->encryption_url->safe_b64encode($value->id).'/1') ?>"
                                                            class="purple hoverable"><i
                                                    ...
                                                    <td><?php echo $value->verified==1?'<p class="status green darken-2">Active</p>':'<p class="status red darken-2">Blocked</p>' ; ?>
                                                    </td>
                                                </tr>
                                                <?php } } ?>
                                            </tbody>
