    ...
    <section class="sec-top">
            ...
            <div class="row">
                ...
                <div class="col m12 s12 l9">
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m6">
                                <p class="h5-para black-text m0">Gallery - Videos : <?php echo $pagetype; ?></p>
                            </div>
                            <div class="col s12 m6 l6 right-align">
                                <a href="<?php echo base_url('gallery-videos/upload/'.$type); ?>" class="btn btn-form btn-submit">Add
                                    Video : <?php echo $pagetype; ?></a>
                            </div>
                        </div>
                                      ...
                                      ?>
                                                <tr>
                                                    ...
                                                    <td class="action-btn  center-align">
                                                        <!-- view user -->
                                                        <a 
                                                            class="blue hoverable modal-trigger modalBtn" href="#modal1"
                                                        video_url="<?php echo $value->youtube;?>"><i class="far fa-eye "></i></i></a>
                                                    ...
                                                    <td><?php echo (!empty($value->youtube))?$value->youtube:'---' ; ?></td>
                                                </tr>
                                                <?php } } ?>
                                            </tbody>
                                        </table>
        ...
        <div id="modal1" class="modal">
            <div class="modal-content">
                <iframe id="iframeVdo" src="" title="YouTube video player"
                    frameborder="0"
...
function myconfirmPromt(id,type) {
  ...
  if(ans!=false){
    window.location.href = "<?php echo base_url('gallery-videos/delete/'.'') ?>"+id+"/"+type;
  }
}
</script>
