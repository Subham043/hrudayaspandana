                    ...
                    <div class="main-bar">
                        ...
                        <div class="row">
                            <div class="col 12 m12">
                                <p class="h5-para black-text m0">Event - Edit</p>
                            </div>
                        ...
                        <div class="card box-shadow form-card ">
                            <div class="ufg-job-application-wrapper">
                                <form
                                    action="<?php echo base_url('events/edit/'.$this->encryption_url->safe_b64encode($result->id)); ?>"
                                                ...
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control inner-pad" name="sdate"
                                                            id="sdate" value="<?php echo $result->sdate; ?>">
                                                ...
                                                <div class="col s12 m6 l4" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control inner-pad" name="edate"
                                                            id="edate" value="<?php echo $result->edate; ?>">
                                                ...
                                                <div class="col s12 m6 l6" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" class="form-control inner-pad" name="stime"
                                                            id="stime" value="<?php echo $result->stime; ?>">
                                                ...
                                                <div class="col s12 m6 l6" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" class="form-control inner-pad" name="etime"
                                                            id="etime" value="<?php echo $result->etime; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            <option value="1"
                                                                ...
                                                                Upcoming</option>
                                                            <option value="2"
                                                                <?php echo $result->status == 2 ? 'selected' : ''; ?>>
                                                                Completed</option>
                                                        </select>
                                                        <div style="color:red;"><?php echo form_error('status'); ?>
                                                        </div>
                                    ...
                                    <fieldset>
                                        <legend>Edit Event Description</legend>
                                        <div class="input-type-block">
                                                ...
                                                <div class="col s12 m12 l12" style="margin-top:15px;">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description3" id="description3" rows="10"
                                                            class="form-control inner-pad textarea"><?php echo $result->description3!=null ? $result->description3 : ''; ?></textarea>
                                                        <div style="color:red;">
